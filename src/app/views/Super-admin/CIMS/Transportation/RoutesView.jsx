...
import {
    ...
    DialogTitle, DialogContent, DialogActions, Tooltip, Avatar
} from "@mui/material";
import {
    Search, Add, Map, Route, DirectionsBus, AccessTime,
    People, Close, Visibility, Edit, LocationOn, Schedule,
    ArrowForward
} from "@mui/icons-material";
import { T, fontHead, fontBody, fontMono, Fonts, routes, statusColors } from "./transportShared";
...
/* ── Mock stop data for route detail ── */
    ...
    return (
        <Box sx={{ p: 3, background: T.bg, minHeight: "100vh", fontFamily: fontBody }}>
            ...
            <Box display="flex" justifyContent="space-between" alignItems="flex-start" mb={3} className="fade-up">
                <Box>
                    <Typography sx={{ fontFamily: fontBody, fontSize: "0.72rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: T.textMute, mb: 0.3 }}>Transportation · Routes</Typography>
                    <Typography sx={{ fontFamily: fontHead, fontWeight: 700, fontSize: "1.5rem", color: T.text, lineHeight: 1.1 }}>Route Management</Typography>
                    <Typography sx={{ fontFamily: fontBody, fontSize: "0.82rem", color: T.textSub, mt: 0.4 }}>Configure bus routes, stops, schedules, and coverage areas.</Typography>
                </Box>
            ...
            {/* ── Route Detail Dialog with Stop Timeline ── */}
