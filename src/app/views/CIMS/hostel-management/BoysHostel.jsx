...
export default function BoysHostel() {
    ...
    const [allocations, setAllocations] = useState([
        { id: 1, studentName: "Rahul Sharma", roomNumber: "A-101", block: "Block A", checkInDate: "2023-08-15", status: "Occupied" },
        { id: 2, studentName: "Amit Kumar", roomNumber: "B-302", block: "Block B", checkInDate: "2023-08-20", status: "Occupied" },
        { id: 3, studentName: "Vikram Singh", roomNumber: "A-105", block: "Block A", checkInDate: "2023-09-01", status: "Pending" },
    ]);

    const students = [
        { id: 101, name: "Rahul Sharma", rollNo: "CS21045", course: "B.Tech CSE", room: "A-101", contact: "9876543210" },
        { id: 102, name: "Amit Kumar", rollNo: "EC21012", course: "B.Tech ECE", room: "B-302", contact: "9876543211" },
    ];

    const [visitors, setVisitors] = useState([
        { id: 1, visitorName: "Rajesh Sharma", relation: "Father", studentName: "Rahul Sharma", date: "2023-10-15", inTime: "10:00", outTime: "12:30" },
    ]);

    const complaints = [
        { id: "C-101", title: "Fan not working", room: "A-101", date: "2023-10-20", status: "Open", priority: "High" },
        { id: "C-102", title: "Leaking tap", room: "B-302", date: "2023-10-18", status: "Resolved", priority: "Medium" },
    ];
        ...
        <Box sx={{ p: 3, background: T.bg, minHeight: "100vh", fontFamily: fontBody }}>
            ...
            <Box display="flex" justifyContent="space-between" alignItems="flex-start" mb={3} className="fade-up">
                <Box>
                    ...
                    <Typography sx={{ fontFamily: fontHead, fontWeight: 700, fontSize: "1.5rem", color: T.text, lineHeight: 1.1 }}>Boys Hostel Management</Typography>
                    <Typography sx={{ fontFamily: fontBody, fontSize: "0.82rem", color: T.textSub, mt: 0.4 }}>Manage room allocations, students, visitors, and complaints for boys hostels.</Typography>
                </Box>
            ...
            <Grid container spacing={3} mb={3}>
                <Grid item xs={12} sm={6} md={3}><StatCard label="Total Capacity" value="700" sub="Across 2 blocks" color={T.accent} bgLight={T.accentLight} icon={People} /></Grid>
                <Grid item xs={12} sm={6} md={3}><StatCard label="Occupied" value="670" sub="Students currently residing" color={T.success} bgLight={T.successLight} icon={HowToReg} /></Grid>
